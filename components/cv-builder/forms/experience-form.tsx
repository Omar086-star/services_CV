...
function SortableExperienceItem({ experience, onUpdate, onRemove }: SortableExperienceItemProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
      ...
      <CardContent className="p-4 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-medium flex-1">
            {experience.position || experience.company || 'خبرة جديدة'}
          </h4>
          <Button
            type="button"
            variant="ghost"
        ...
        <div className="flex items-center gap-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => 
              onUpdate(experience.id, { current: checked as boolean, endDate: '' })
            }
          />
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="صف مسؤولياتك وإنجازاتك في هذا الدور..."
            rows={3}
          />
        </div>
      </CardContent>
    ...
    <div className="space-y-4">
      ...
      {experiences.length === 0 ? (
        <div className="text-center py-8 text-muted-foreground border-2 border-dashed rounded-lg">
          <p>لم تتم إضافة أي خبرات بعد</p>
          <p className="text-sm mt-1">انقر على &quot;إضافة خبرة&quot; للبدء</p>
        </div>
      ) : (
        <DndContext
          sensors={sensors}
